...
- An escort picks an adult guest nearby, winners and the drunk first, walks over and talks (a vice incident everyone nearby can see). The guest says yes with a chance set by their type's appetite for vice, how drunk they are and whether they're winning. A guest who says yes leaves with them: by the elevator, where the room they take earns the house $50, or out the street door.
