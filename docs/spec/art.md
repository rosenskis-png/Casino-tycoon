...
- **Type silhouettes** (the M3.1 brief): Locals casual (tees, jeans, caps). Retirees one row shorter, puffed grey/lavender hair or bald, cardigans, pastels, glasses. Tourists wide sun hats, loud patterned shirts, shorts, cameras. Party guests dark blazers and quiffs, or bright short dresses. Staff read by uniform color (player-set per job since M11, docs/spec/staff.md), a head silhouette and a prop: janitor coverall + cap + mop (a bucket while sweeping), tech vest + tall hard hat + toolbox, server vest + bow tie + tray, security guard jacket + black peaked cap with a red badge + radio, pit boss dark suit + clipboard, surveillance operator polo + headset, enforcer black + dark glasses, dealer jacket + bow tie + green visor. Hats and head-worn accessories (visor, headset, shades) are drawn over the hair. Visitors: police officer navy with a cap and belt, paramedic white with a red belt.
