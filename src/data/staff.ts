...
export const STAFF_ROLES: Record<string, StaffRole> = {
  ...
  guard: { id: "guard", name: "Security guard", wage: 50, desc: "Patrols, answers reports, and enforces the house rules." },
  ...
  enforcer: { id: "enforcer", name: "Enforcer", wage: 75, desc: "Warns, bans, beats or disappears guests: on your orders, or as the house treatment for caught cheats." },
};
