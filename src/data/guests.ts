...
export const GUEST_TYPES: Record<string, GuestTypeDef> = {
  ...
  tourist: {
    ...
    chase: 0.003,
    credit: 0,
    games: { cherry: 0.8, liberty: 0.4, thunder: 1, vpoker: 0.3, blackjack: 0.6, roulette: 1, craps: 0.8, baccarat: 0.3, poker: 0.3, keno: 0.4, bingo: 0.1 },
  ...
  party: {
    ...
    chase: 0,
    credit: 0,
    games: { cherry: 0.7, liberty: 0.3, thunder: 1, vpoker: 0.1, blackjack: 0.6, roulette: 0.7, craps: 1, baccarat: 0.2, poker: 0.3, keno: 0, bingo: 0 },
