...
export const RESEARCH: Record<string, ResearchDef> = Object.fromEntries([
  ...
  R({ id: "holdspin", name: "Hold & spin", cat: "games", cost: 4000, needs: ["video"], desc: "Orbs that lock and respin, with jackpot orbs and a screen-filling Grand." }),
  R({ id: "bonusgames", name: "Pick and wheel bonuses", cat: "games", cost: 3500, desc: "Pick bonuses, wheels (on screen or on top of the cabinet) and take-it-or-leave-it offers." }),
  R({ id: "cascades", name: "Cascades and collectors", cat: "games", cost: 3500, needs: ["video"], desc: "Tumbling reels with climbing multipliers, collector meters kept on the machine, mystery multipliers and wild storms." }),
