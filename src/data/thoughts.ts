...
export const THOUGHTS: Record<string, ThoughtDef> = {
  ...
  handpayWait: { text: "Waiting on my hand pay. Somebody get over here!", alt: ["They have to pay this one by hand!", "My hand pay's coming!"] },
  handpaid: { text: "Cash in hand! What a night!", alt: ["They counted it out right in front of me!", "Best hand pay ever."] },
  cheer: { text: "Somebody hit the big one!", alt: ["Whoa, a jackpot! Look at that!", "Did you see that? The top prize!"] },
