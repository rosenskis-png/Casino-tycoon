...
export const GUEST_TYPES: Record<string, GuestTypeDef> = {
  local: {
    ...
    play: { stake: [0.006, 0.015], pace: [0.9, 1.2], quit: { winGoal: 2, lossLimit: 3, broke: 1, jackpot: 1 }, winGoal: [0.5, 1.2], lossLimit: [0.6, 1], compSeek: 0.2 },
    ...
    themes: { goldrush: 0.6, ratpack: 0.4, rock: 0.3, dragon: 0.2, luxe: -0.3, egypt: -0.1, monaco: -0.3 },
  },
  retiree: {
    ...
    play: { stake: [0.0075, 0.0175], pace: [0.7, 1], quit: { winGoal: 3, lossLimit: 4, broke: 0.5, jackpot: 1 }, winGoal: [0.3, 0.8], lossLimit: [0.5, 0.9], compSeek: 0.4 },
    ...
    themes: { ratpack: 0.9, deco: 0.6, riviera: 0.4, rome: 0.2, rock: -0.4, atomic: -0.6, pirate: -0.2, tiki: -0.2, monaco: 0.3 },
  },
  tourist: {
    ...
    budget: { median: 360, sigma: 0.7, min: 60, cap: 4000 },
    minutes: { mean: 5.5, sd: 2, min: 1 },
    savings: { median: 6000, sigma: 1, min: 200 }, income: { median: 600, sigma: 0.5, min: 100 },
    tripCap: { median: 600, sigma: 0.7, min: 100, cap: 4000 },
    atm: { never: 0.3, draw: { median: 200, sigma: 0.5, min: 40 }, again: 0.35 },
    ...
    play: { stake: [0.005, 0.011], pace: [1, 1.4], quit: { winGoal: 1, lossLimit: 2, broke: 2, jackpot: 1 }, winGoal: [0.8, 2], lossLimit: [0.7, 1], compSeek: 0.05 },
    ...
    themes: { rome: 0.7, egypt: 0.7, pirate: 0.5, tiki: 0.5, medieval: 0.4, riviera: 0.3, goldrush: 0.3, dragon: 0.3, monaco: 0.3 },
  },
  party: {
    ...
    budget: { median: 240, sigma: 0.5, min: 60, cap: 1600 },
    minutes: { mean: 6.5, sd: 2.5, min: 1 },
    savings: { median: 4000, sigma: 1, min: 200 }, income: { median: 600, sigma: 0.5, min: 100 },
    tripCap: { median: 500, sigma: 0.6, min: 80, cap: 1600 },
    atm: { never: 0.2, draw: { median: 160, sigma: 0.5, min: 40 }, again: 0.4 },
    ...
    play: { stake: [0.011, 0.025], pace: [1, 1.4], quit: { winGoal: 1, lossLimit: 2, broke: 2, jackpot: 1 }, winGoal: [0.8, 2], lossLimit: [0.7, 1], compSeek: 0.02 },
    ...
    themes: { atomic: 0.9, rock: 0.8, tiki: 0.5, pirate: 0.2, ratpack: -0.3, deco: -0.3, medieval: -0.2, riviera: -0.2, monaco: -0.2 },
  },
  highroller: {
    ...
    tableStake: 0.4, rules: 1, skill: [0.15, 0.5, 0.35], counters: 0.02, tableDraw: 0.85,
  ...
  conventioneer: {
    ...
    budget: { median: 300, sigma: 0.6, min: 80, cap: 3000 },
    minutes: { mean: 5, sd: 2, min: 1 },
    savings: { median: 10000, sigma: 1, min: 1000 }, income: { median: 1000, sigma: 0.5, min: 200 },
    tripCap: { median: 600, sigma: 0.6, min: 100, cap: 4000 },
    atm: { never: 0.4, draw: { median: 200, sigma: 0.5, min: 40 }, again: 0.3 },
    ...
    play: { stake: [0.005, 0.0125], pace: [1, 1.3], quit: { winGoal: 1, lossLimit: 2, broke: 1, jackpot: 1 }, winGoal: [0.8, 2], lossLimit: [0.6, 1], compSeek: 0.05 },
    ...
    themes: { luxe: 0.4, rome: 0.4, riviera: 0.4, atomic: 0.3, rock: 0.3, goldrush: 0.1, monaco: 0.4 },
  },
  ...
  family: {
    ...
    kids: { adults: [1, 2] },
    budget: { median: 200, sigma: 0.6, min: 40, cap: 1600 },
    minutes: { mean: 4.5, sd: 1.5, min: 1 },
    savings: { median: 6000, sigma: 1, min: 200 }, income: { median: 600, sigma: 0.5, min: 100 },
    tripCap: { median: 300, sigma: 0.6, min: 40, cap: 1600 },
    atm: { never: 0.5, draw: { median: 120, sigma: 0.5, min: 40 }, again: 0.2 },
    ...
    play: { stake: [0.005, 0.01], pace: [0.8, 1.1], quit: { winGoal: 2, lossLimit: 3, broke: 1, jackpot: 1 }, winGoal: [0.5, 1.5], lossLimit: [0.5, 0.8], compSeek: 0 },
    ...
    themes: { pirate: 0.9, tiki: 0.7, medieval: 0.6, egypt: 0.4, rome: 0.2, rock: -0.2, ratpack: -0.3, luxe: -0.2, monaco: -0.3 },
  },
};
