...
export const STAFF = {
  ...
  morale: { base: 50, perPay: 50, drift: 0.25, overworkAt: 0.7, overworkMax: 30, fight: 2, fightMax: 15, firedHonest: 8, quitBelow: 20, quitChance: 0.05 },
