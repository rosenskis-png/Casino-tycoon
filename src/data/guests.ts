...
export const GUEST_TYPES: Record<string, GuestTypeDef> = {
  local: {
    ...
    play: { stake: [0.0025, 0.006], pace: [0.9, 1.2], quit: { winGoal: 2, lossLimit: 3, broke: 1, jackpot: 1 }, winGoal: [0.5, 1.2], lossLimit: [0.6, 1], compSeek: 0.2 },
  ...
  retiree: {
    ...
    play: { stake: [0.003, 0.007], pace: [0.7, 1], quit: { winGoal: 3, lossLimit: 4, broke: 0.5, jackpot: 1 }, winGoal: [0.3, 0.8], lossLimit: [0.5, 0.9], compSeek: 0.4 },
  ...
  party: {
    ...
    play: { stake: [0.0045, 0.01], pace: [1, 1.4], quit: { winGoal: 1, lossLimit: 2, broke: 2, jackpot: 1 }, winGoal: [0.8, 2], lossLimit: [0.7, 1], compSeek: 0.02 },
