...
- **Tap a notice (M11, owner):** a news item can say what it's about (`NewsRef`: a person, a tile, or a tab), saved with it in the log. Tapping it on the ticker (marked ›) or in the Log centers the camera there (Default zoom if further out) and opens the person's card, or the card of what stands on the tile (a machine's card leads to playing it); a tab reference opens that tab. A person who has left falls back to where they were when it was posted. Carried by: incidents and reports, police calls, officers' fines, paramedics, caught cheats, card counters, marked guests coming and going, whales arriving, jackpots, staff caught stealing, the inspector; the ladders, scandals and rumors open Authorities, money trouble Finance, quits Staff, research Research, designs and offers Slots, goals Goals.
