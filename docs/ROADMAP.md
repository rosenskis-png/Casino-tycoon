...
- **Guest psychology ☑ (M11.3, owner):** temptation by hooks and layout with no per-crowd ceiling, savvy (edge-seeking, discipline, eroded by drink and drugs), showing off, wide stacking decor, the six-crowd roster (conventioneers an event crowd), six crowd floors and `npm run parity`. Open: high rollers' take.
